...
file = open("9. Mapeos.md", "w")
for i in range(100):
    if i<10:
        file.write("![](http://kunusoft.com/slides/bd1/bd109_mapeos/Diapositiva0"+str(i)+".JPG)" + os.linesep)
    else:
        file.write("![](http://kunusoft.com/slides/bd1/bd109_mapeos/Diapositiva"+str(i)+".JPG)" + os.linesep)
